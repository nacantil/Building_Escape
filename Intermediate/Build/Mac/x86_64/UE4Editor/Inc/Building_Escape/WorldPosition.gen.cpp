...
#include "Building_Escape/WorldPosition.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BUILDING_ESCAPE_API UClass* Z_Construct_UClass_UWorldPosition_NoRegister();
	BUILDING_ESCAPE_API UClass* Z_Construct_UClass_UWorldPosition();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS(UWorldPosition, 1646712549);
	template<> BUILDING_ESCAPE_API UClass* StaticClass<UWorldPosition>()
	{
		return UWorldPosition::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UWorldPosition(Z_Construct_UClass_UWorldPosition, &UWorldPosition::StaticClass, TEXT("/Script/Building_Escape"), TEXT("UWorldPosition"), false, nullptr, nullptr, nullptr);
